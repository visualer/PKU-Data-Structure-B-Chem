...
class LCList():#LDCList, without iterator
    ...
    #pointer based dangerous operations, needs condition
    def _Delete_this(self, it):
        it.prev.next=it.next
        it.next.prev=it.prev
        self._length-=1
        return it.elem
    def _Append_this(self, it, elem):
        it.next=LNode(elem, it, it.next)
        it.next.next.prev=it.next
        self._length+=1
        pass
    def _Prepend_this(self, it, elem):
